...
- 💼 Atuação em Engenharia de Dados na PREVI
- 📊 Experiência com Databricks, Spark SQL, Python, Azure Data Factory e Power BI
- ☁️ Estudando Cloud Computing, Engenharia de Dados e Arquitetura de Dados
- 🚀 Buscando evoluir profissionalmente e construir soluções úteis com dados
...
- 🍕 **Projeto Pizzaria** — Sistema para montagem de pizzas personalizadas com HTML, CSS, Bootstrap e PHP.
- 🚲 **Projeto Bikecraft** — Página web responsiva utilizando HTML e CSS.
- 🚗 **Ticket Veículos** — Sistema em Python para controle de tags de veículos.
- 🌐 **Portfólio Pessoal** — Site com meus projetos, experiências e habilidades.
...
<p align="center">
  <a href="https://www.linkedin.com/in/gabriel-reis-9aab63239">
